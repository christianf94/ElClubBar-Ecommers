    ...
    return (
        <body className="container">
            <section className="itemContainer">
                ...
                <ItemCard src="https://http2.mlstatic.com/pack-x-24-barstow-honey-cerveza-artesanal-lata-473ml-D_NQ_NP_989777-MLA41962435260_052020-F.webp" alt="Cerveza Barstow Honey Pack latas x6" item="BARSTOW HONEY PACK X6" price="$740" stock="4"/>
                <ItemCard src="https://http2.mlstatic.com/pack-x-24-barstow-honey-cerveza-artesanal-lata-473ml-D_NQ_NP_858834-MLA41962156951_052020-F.webp" alt="Cerveza Barstow Mix x24" item="BARSTOW MIX ALL STYLES PACK X24" price="$4210" stock="8"/>
                <ItemCard src="https://http2.mlstatic.com/D_NQ_NP_745296-MLA43061864203_082020-O.jpg" alt="Pampa Mix 3 Styles x6" item="PAMPA MIX 3 STYLES PACK X6" price="$1000" stock="14"/>
                <ItemCard src="https://d26lpennugtm8s.cloudfront.net/stores/871/106/products/andes-roja-pack11-ad5c9e7458f3b57cbb15603448579585-1024-1024.png" alt="Cerveza Andes Roja Pack latas x6" item="ANDES ROJA ROJA X6" price="$730" stock="2"/>
                </article>
            </section>
        </body>
    )

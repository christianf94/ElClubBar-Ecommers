    ...
    return (
        <body className="container">
            <section className="itemContainer">
                ...
                <ItemCard src="https://d26lpennugtm8s.cloudfront.net/stores/871/106/products/andes-roja-pack11-ad5c9e7458f3b57cbb15603448579585-1024-1024.png" alt="Cerveza Andes Roja Pack latas x6" item="ANDES PACK ROJA X6" price="$730" stocks="2"/>
                </article>
            </section>
        </body>
    )
